  ...
  return (
    ...
    >
      ...
      <aside className="w-full md:w-64 flex-shrink-0">
        <div className="bg-gradient-to-b from-gray-900 to-black p-6 rounded-2xl shadow-2xl border border-indigo-500/20 backdrop-blur-md sticky top-4">
          ...
          <form onSubmit={handleFilter} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Max Fees (₹)</label>
              <input
                type="number"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl hover:scale-[1.02] hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300"
            >
              Apply Filters
            </button>
            ...
            <button
              ...
              className="text-sm text-gray-400 hover:text-indigo-400 transition mt-3"
            >
              Clear Filters
            </button>
          </form>
      ...
      <div className="flex-1">
        <div
            className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-950 via-gray-900 to-black px-8 py-16 mb-10 shadow-2xl border border-indigo-500/20">
            ...
            <div className="mt-8 max-w-2xl">  
              <div className="flex items-center bg-white/10 border border-white/10 rounded-2xl backdrop-blur-md overflow-hidden shadow-xl">
                <input
                  ...
                  className="w-full min-w-0 bg-transparent px-5 py-4 text-white placeholder-gray-400 focus:outline-none"
                />
                ...
                <button
                  ...
                  className="flex-shrink-0 bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 text-white font-medium transition-all duration-300 hover:brightness-110 hover:scale-[1.02] hover:shadow-lg hover:shadow-indigo-500/30"
                >
                  Search
                </button>
        ...
        {loading ? (
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-12 text-center rounded-3xl border border-indigo-500/20 shadow-2xl"> 
            ...
            <button 
              type='button'
              onClick={() => { setSearch(''); setLocation(''); setMaxFees(''); setTimeout(loadColleges, 0); }}
